...
The product uses pink for Human Candy, yellow for AI Candy, and white rainbow for the shared Blend view. Colors should help users understand wallet state and purpose, not create confusing separate currencies.
